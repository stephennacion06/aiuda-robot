...
from aiuda_distribution.aiuda_db_modules import find_qr_code
from aiuda_cabinet.aiuda_cabinet_commands import deactivate_all_cabinet, activate_slot
import threading
import time 
        ...
        while ret:
            ...
            if (cv2.waitKey(1) & 0xFF == 27) or (bool_end_scan == True):
                try:
                    ...
                    print('Error on Restarting Parameters')
